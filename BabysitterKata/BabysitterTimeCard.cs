...
namespace BabysitterKata
{
    public class BabysitterTimeCard
    {
        ...
        private TwentyFourHourTime ONE_MINUTE_TO_MIDNIGHT = new TwentyFourHourTime(11, 59);
        ...
        {
            if (endTime.CompareTo(EARLIEST_START_TIME) > 0 || endTime.CompareTo(LATEST_END_TIME) <= 0)
                return true;
